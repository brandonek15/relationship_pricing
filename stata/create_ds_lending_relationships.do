...
local base_vars borrowercompanyid $ds_types $rel_states spread discount_1_simple discount_1_controls d_1_simple_pos d_1_controls_pos log_facilityamt maturity
*sdc_vars are the variables you want from the most recent equity,debt,conv offerings
local sdc_vars $rel_states gross_spread_perc proceeds log_proceeds
*ds_vars are the variables you want from the most recent term,rev,other loans 
local ds_vars $rel_states loantype packageid log_facilityamt maturity discount_1_simple discount_1_controls d_1_simple_pos d_1_controls_pos spread ///
